...
<form action="/webapp-form/registro" method="post">
    ...
    <div class="row mb-3">
        ...
        <%
                if(errores !=null &&errores.containsKey("password")){
                    out.println("<small class='row mb-3 alert alert-danger col-sm-4' style='color: red;'>"+errores.get("password")+"</small>");
                }
        %>
        ...
        <div class="col-sm-4"> <input type="text" name="email", id="email" class="form-control" value="${param.email}"> </div>
         ...
         <%
            if(errores !=null &&errores.containsKey("email")){
                out.println("<small class='row mb-3 alert alert-danger col-sm-4' style='color: red;'>"+errores.get("email")+"</small>");
            }
         %>
        ...
        <div class="col-sm-4">
         ...
         <%
            if(errores !=null &&errores.containsKey("pais")){
                out.println("<small class='row mb-3 alert alert-danger col-sm-4' style='color: red;'>"+errores.get("pais")+"</small>");
            }
         %>
        ...
        <div class="col-sm-4">
         ...
         <%
            if(errores !=null &&errores.containsKey("lenguajes")){
                out.println("<small class='row mb-3 alert alert-danger col-sm-4' style='color: red;'>"+errores.get("lenguajes")+"</small>");
            }
         %>
    ...
    <div class="row mb-3">
        ...
        <div class="form-check col-sm-2">
            ...
            <label class="form-check-label">Administador</label>
        </div>
        <div class="form-check col-sm-2">
        ...
        <%
            if(errores !=null &&errores.containsKey("roles")){
                out.println("<small class='row mb-3 alert alert-danger col-sm-4' style='color: red;'>"+errores.get("roles")+"</small>");
            }
         %>
    <div class="row mb-3">
        ...
        <%
            if(errores !=null &&errores.containsKey("idioma")){
                out.println("<small class='row mb-3 alert alert-danger col-sm-4' style='color: red;'>"+errores.get("idioma")+"</small>");
            }
         %>
    <div class="row mb-3">
